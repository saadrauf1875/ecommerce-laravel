                              ...
                              <div class="card-body">
                                  <div class="d-flex">
                                      <div class="mt-2">
                                          ...
                                          <h2 class="mb-0 number-font">{{$total_product}}</h2>
                                      </div>
                                      <div class="ms-auto">
                              ...
                              <div class="card-body">
                                  <div class="d-flex">
                                      <div class="mt-2">
                                          ...
                                          <h2 class="mb-0 number-font">{{$total_order}}</h2>
                                      </div>
                                      <div class="ms-auto">
                                          <div class="chart-wrapper mt-1">
                              ...
                              <div class="card-body">
                                  <div class="d-flex">
                                      <div class="mt-2">
                                          ...
                                          <h2 class="mb-0 number-font">{{$total_user}}</h2>
                                      </div>
                                      <div class="ms-auto">
                                          <div class="chart-wrapper mt-1">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        <h6 class="">Order Delivery</h6>
                                        <h2 class="mb-0 number-font">{{$total_delivered}}</h2>
                                    </div>
                                    <div class="ms-auto">
                                        <div class="chart-wrapper mt-1">
                                            <canvas id="saleschart"
                          ...
                          <div class="card-body">
                              <div class="d-flex">
                                  <div class="mt-2">
                                      ...
                                      <h2 class="mb-0 number-font">{{$total_processing}}</h2>
                                  </div>
                                  <div class="ms-auto">
                                      <div class="chart-wrapper mt-1">
                                          <canvas id="saleschart"
