        ...
        <div class="row table_addproduct  mt-6">
            <div class="col-xl-8 col-lg-12 mt-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('/add_products')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            <div class="row mb-4">
                                <label class="col-md-3 form-label" for="example-email">Product Name:</label>
                                <div class="col-md-9">
                                    <input type="text"  class="form-control" name="title" id="field" placeholder="Enter Product Name:" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="description" id="field" placeholder="Enter Product Description:" required class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="quantity" id="field" placeholder="Enter Product  Quantity:" required class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="price" id="field"  placeholder="Enter Product price" required class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="discount_price" id="field"  placeholder="Enter Product  Discount Price:" class="form-control" >
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select class="form-control" name="category" id="field"  required>
                                        <option label="Select">Country</option>
                                            ...
                                            <option value="" selected="">Enter a Category  :</option>
